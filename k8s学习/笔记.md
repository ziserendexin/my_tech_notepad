...
11. 终于特么启动起来了
    ...
    ```bash
    kubeadm join 192.168.253.142:6443 --token jbfrxs.83kwwwjxjpa5yi6b \
        --discovery-token-ca-cert-hash sha256:65609f4aff55bc5ee4760ff769039b1e8e86cc2cc683da6e906727f83e43a902
    ```
...
13. dashboard
    ...
    另外还有两个coredns也处于pending状态。<!--你两是干嘛的，为啥不启动啊-->
